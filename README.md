...
To build the final jar and optimize the pavoApplication application for production, run:
...
Then navigate to [http://localhost:3434](http://localhost:3434) in your browser.
