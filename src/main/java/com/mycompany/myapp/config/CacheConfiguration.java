...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer(javax.cache.configuration.Configuration<Object, Object> jcacheConfiguration) {
        return cm -> {
            ...
            createCache(cm, com.mycompany.myapp.domain.NewCompany.class.getName(), jcacheConfiguration);
            createCache(cm, com.mycompany.myapp.domain.CompanyD.class.getName(), jcacheConfiguration);
